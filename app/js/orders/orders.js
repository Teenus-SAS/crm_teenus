$(document).ready(function () {
  ...
  $('#btnSaveOrder').click(function (e) {
    ...
    $.post(
      ...
      function (data, textStatus, jqXHR) {
        ...
        if (data.error) toastr.info(data.message);
      }
    );
  });
  ...
  $(document).on('click', '.cancelOrder', function (e) {
    ...
    alertify
      .confirm(
        'teenus',
        `¿Realmente desea <b>anular el pedido No. ${data.id_order}</b>?`,
        function () {
          alertify
            .prompt(
              'teenus',
              ...
              function (evt, value) {
                $.ajax({
                  ...
                  success: function (data) {
                    ...
                    if (data.error) toastr.error(data.message);
                  },
                });
              },
              function () {
                toastr.info('Anulación de Pedido sin observaciones');
              }
            )
