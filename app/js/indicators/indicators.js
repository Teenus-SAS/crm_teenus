    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response[2].valuedBusiness != null)
                $('.valuedBusiness').html(`$${response[2].valuedBusiness.toLocaleString().replace(/,/g, " ",)}`);
            else
                $('.valuedBusiness').html(`$0`);

            if (response[3].valuedOrders != null)
                $('.valuedOrders').html(`$${response[3].valuedOrders.toLocaleString().replace(/,/g, " ",)}`);
            else
                $('.valuedOrders').html(`$0`);
        }
    });
        ...
        $.ajax({
            ...
            success: function(resp) {
                ...
                for (let i = 1; i < resp.length; i++) {
                    if (resp[i].month == 'January')
                        orders.push(resp[i].won);
                    else
                        orders.push(0);
                    if (resp[i].month == 'February')
                        orders.push(resp[i].won);
                    else
                        orders.push(0);
                    if (resp[i].month == 'March')
                        orders.push(resp[i].won);
                    else
                        orders.push(0);
                    if (resp[i].month == 'April')
                        orders.push(resp[i].won);
                    else
                        orders.push(0);
                    if (resp[i].month == 'May')
                        ...
                        orders.push(0);
                    if (resp[i].month == 'June')
                        orders.push(resp[i].won);
                    else
                        orders.push(0);
                    if (resp[i].month == 'July')
                        orders.push(resp[i].won);
                    else
                        orders.push(0);
                    if (resp[i].month == 'Aguost')
                        orders.push(resp[i].won);
                    else
                        orders.push(0);
                    if (resp[i].month == 'September')
                        orders.push(resp[i].won);
                    else
                        orders.push(0);
                    if (resp[i].month == 'October')
                        orders.push(resp[i].won);
                    else
                        orders.push(0);
                    if (resp[i].month == 'November')
                        orders.push(resp[i].won);
                    else
                        orders.push(0);
                    if (resp[i].month == 'December')
...
winLoseProjects = (id) => {
    ...
    $.ajax({
        ...
        success: function(resp) {
            ...
            for (let i = 0; i < resp.length; i++) {
                if (resp[i].month != month[i - 1])
                    month.push(resp[i].month);
                if (resp[i].won != undefined)
                    quantitywon.push(resp[i].won);
                if (resp[i].fail != undefined)
                    quantityfail.push(resp[i].fail);
            }
        ...
        success: function(resp) {
            ...
            for (let i = 0; i < resp.length; i++) {
                if (resp[i].month != month[i - 1])
                    month.push(resp[i].month);
                if (resp[i].won != undefined)
                    valuedwon.push(resp[i].won);
                if (resp[i].fail != undefined)
                    valuedfail.push(resp[i].fail);
            }
