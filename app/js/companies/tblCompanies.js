...
tableCompanies = $('#tableCompanies').dataTable({
    ...
    columns: [{
        ...
        },
        {
            ...
            render: function(data) {
                return `
                <a href="javascript:;" <i id="${data}"" class="bx bx-transfer reassignCompanies" data-toggle='tooltip' title='Reasignar Empresa a Nuevo Comercial' style="font-size: 35px;"></i></a>`
            }
        },
    ],
})