...
<body>
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					...
					<div class="ms-auto">
						<div class="btn-group">
							...
							<button type="button" class="btn btn-primary" id="btnCreateContact" data-bs-toggle="modal" data-bs-target="#modalCreateQuote">Crear Nueva Cotización</button>
						</div>
					</div>
				</div>
	...
	<script src="../../js/quotes/quotes.js"></script>
